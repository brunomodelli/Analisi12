			...
			for (int x = 0; x <= xmax; x++) {
				...
				for (int y = 0; y <= ymax; y++) {
					...
					for (int z = 0; z <= zmax; z++) {
						...
						currEval=UtilsControls.controlNewMaxBy1(newMaxBy,all,currentProfit,currEval);
						currEval=UtilsControls.controlNewMaxBy2(newMaxBy,all,currentProfit,currEval);
						currEval=UtilsControls.controlNewMaxBy3(newMaxBy,all,currentProfit,currEval);
